...
config :lumina, LuminaWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: LuminaWeb.ErrorHTML, json: LuminaWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Lumina.PubSub,
  live_view: [signing_salt: "pdeDryeV"]
...
config :lumina, Lumina.Mailer, adapter: Swoosh.Adapters.Local
