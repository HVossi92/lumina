defmodule LuminaWeb.Components.Spinner do
  @moduledoc """
  The `LuminaWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `LuminaWeb.Components.Spinner` module enables developers to provide
