defmodule LuminaWeb.Components.Overlay do
  @moduledoc """
  The `LuminaWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `LuminaWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,
