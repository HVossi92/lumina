defmodule LuminaWeb.Components.Tabs do
  @moduledoc """
  `LuminaWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/tabs
  ...
  import LuminaWeb.Components.Badge, only: [badge: 1]
