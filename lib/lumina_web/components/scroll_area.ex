defmodule LuminaWeb.Components.ScrollArea do
  @moduledoc """
  The `LuminaWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView
