defmodule LuminaWeb.Components.Menu do
  @moduledoc """
  The `LuminaWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `LuminaWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/menu
  ...
  import LuminaWeb.Components.Button, only: [button_link: 1]
