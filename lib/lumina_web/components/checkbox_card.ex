defmodule LuminaWeb.Components.CheckboxCard do
  @moduledoc """
  The `LuminaWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
