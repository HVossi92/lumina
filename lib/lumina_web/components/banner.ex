defmodule LuminaWeb.Components.Banner do
  @moduledoc """
  LuminaWeb.Components.Banner module provides components for rendering customizable banners in your **Phoenix LiveView**
  application.
